  ...
  return (
    <section ref={sectionRef} className="py-24 relative overflow-hidden">
      <div className="container-wide">
        <div
          className="reveal-hidden relative rounded-3xl overflow-hidden p-10 md:p-16 text-center"
          style={{
        ...
        >
          ...
          <div
            className="absolute bottom-0 right-1/4 w-48 h-48 orb bg-aivl-cyan/10 animate-orb-drift"
          ...
          <div className="relative z-10">
            <span className="tag-badge mb-6 inline-block">Start Your AI Implementation</span>

            <h2 className="font-display font-bold text-3xl md:text-5xl text-aivl-text-primary mb-4">
              Ready to Implement <span className="gradient-text">AI in Your Business?</span>
            </h2>

            <p className="max-w-lg mx-auto text-aivl-text-secondary text-lg mb-8">
              Share your use case and objectives. AIVentureLink will design the solution,
              orchestrate the right delivery partners, and manage implementation end-to-end.
            </p>
